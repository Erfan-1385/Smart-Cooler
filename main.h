...
/* Private defines -----------------------------------------------------------*/
#define TEMPLATE_Pin GPIO_PIN_0
#define TEMPLATE_GPIO_Port GPIOA
#define FAST_Pin GPIO_PIN_0
#define FAST_GPIO_Port GPIOB
#define MOTOR_Pin GPIO_PIN_1
#define MOTOR_GPIO_Port GPIOB
#define POMP_Pin GPIO_PIN_2
#define POMP_GPIO_Port GPIOB
